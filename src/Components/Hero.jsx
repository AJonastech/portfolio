    ...
    <Nav>
      <div>
        <section className="flex relative bg-[#fff] flex-col md:flex-row w-full h-[80vh]">
          <img
            className="absolute  top-[52px] w-[60%] right-2 md:top-3 md:right-[50%] md:w-[30%]"
            src={grid}
            alt=""
          />
          <img
            className=" absolute  right-[-30px] bottom-8 hidden md:block md:w-20% rotate-90 "
            src={zigzag}
            alt=""
          />
          ...
          <motion.div
            ...
            className="basis-1/2  flex flex-col md:justify-center"
          >
            <motion.p
              initial={{ opacity: 0.8, y: 30 }}
              animate={{ opacity: 1, y: 0 }}
              transition={{ delay: 0.7 }}
              className="md:text-3xl  text-2xl md:pt-0 pt-5 text-darkBlue mb-1 font-medium "
            >
              Hi! My name is
            </motion.p>
            <motion.h1
              ...
              className="md:text-[40px] text-[30px]  mb-4 text-purple font-bold "
            >
              Agu Jonas O.
            </motion.h1>
            <motion.div
            ...
            <p className="md:text-xl mt-[10px] text-[16px] text-darkBlue">
              Crafting <span className=" font-medium text-purple" ref={el} />{" "}
              web experiences.
            </p>
          </motion.div>
          <motion.div
            ...
            animate={{ opacity: 1 }}
            transition={{ delay: 0.6 }}
            className="relative basis-1/2  flex md:justify-center items-center"
          >
            <motion.div
              initial={{ left: 30 }}
              animate={{ left: 0 }}
              transition={{ delay: 0.6 }}
              className="absolute  items-center justify-center flex  w-full h-full"
            >
              <motion.div
                className="container "
            ...
            <motion.img
              initial={{ scale: 0 }}
              animate={{ scale: 1 }}
              className="w-[250px] md:w-[350px] lg:w-[450px] object-cover mx-auto"
              src={splash}
            />
          </motion.div>
        </section>
        <div className="w-full flex justify-between items-center h-[10vh]">
          ...
          <div className="flex gap-2 md:text-3xl text-xl text-darkBlue">
            <Link to="https://github.com/Ajonastech" target="_blank">
              {" "}
              <AiFillGithub />{" "}
            </Link>
            <Link
              to="https://www.linkedin.com/in/agu-jonas-211a651b6/"
              target="_blank"
            >
              <AiFillLinkedin />
            </Link>
            <Link to="https://twitter.com/Agujonas1" target="_blank">
              {" "}
              <AiFillTwitterCircle />
            </Link>
          </div>
